...
def get_questions_past_tense(model, story, bad_questions=None):
  ...
  story3 = "Question 3) Mary was so happy to have finally crossed the street.\n"
  good3 = "Acceptable Answers: Why did Mary cross the street? Why was Mary unhappy? Why was Mary running from someone?\n\n"
  bad3 = "Wrong Answers: What is Mary like? What does Mary do after crossing the street? What does Mary do now that she is happy? What happens next?\n"
...
def get_questions_future_tense(model, story, bad_questions=None):
  instructions = "This is a rubric for grading a student's detective exam. If they give a wrong answer or an answer similar to a wrong answer, subtract one mark. If they give a right answer, add one mark. An answer cannot be both right and wrong. \n"
  story1 = "Question 1) John went for a swim.\n"
  good1 = "Acceptable Answers: What happened after John went swimming? What does John want to do now? How is the world different now that John has gone swimming?\n\n"
  ...
  story3 = "Question 3) Mary was so happy to have finally crossed the street.\n"
  good3 = "Acceptable Answers:  What does Mary do after crossing the street? What is the result of Mary being happy? What happens now that Mary is on the other side of the street?\n\n"
  bad3 = "Wrong Answers: Why did Mary cross the street? Why was Mary unhappy? Why was Mary running from someone? What is Mary like?\n"
